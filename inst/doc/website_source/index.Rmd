...
The legend represents the number of sequences for each taxon level corresponds as both a color gradient and size of vertices.
...
Again, note, that this command will take a while to process. 
...
We can use **Differential Metadiversity Plots** to contrast either:

* relative abundance of taxa in two pair-wise communities
* two primer pairs for coverage of the tree of life
