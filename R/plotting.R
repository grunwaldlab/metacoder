...
#===================================================================================================
#' Plot igraph layout using ggplot2
#' 
#' Makes a ggplot2 plot of a layout generated by igraph.
#' 
#' @param graph An igraph object or \code{data.frame} with columns \code{to} and \code{from}
#' containing vertex ids.
#' @param layout An igraph layout object or \code{data.frame} of x, y coordinants.
#' @param vertex_size A numeric vector with elements corresponding to vertcies in \code{layout}.
#' Used to determine vertex size.
#' @param vertex_color A numeric vector with elements corresponding to vertcies in \code{layout}.
#' Used to determine vertex color.
#' @param vertex_alpha A numeric vector with elements corresponding to vertcies in \code{layout}.
#' Used to determine vertex transparency.
#' @param edge_size A numeric vector with elements corresponding to edges in \code{graph}.
#' Used to determine edge size.
#' @param edge_color A numeric vector with elements corresponding to edges in \code{graph}.
#' Used to determine edge color.
#' @param edge_alpha A numeric vector with elements corresponding to edges in \code{graph}.
#' Used to determine edge transparency.
#' @param label_size A numeric vector with elements corresponding to labels in \code{layout}.
#' Used to determine label size.
#' @param label_color A numeric vector with elements corresponding to labels in \code{layout}.
#' Used to determine label color.
#' @param label_alpha A numeric vector with elements corresponding to labels in \code{layout}.
#' Used to determine label transparency.
igraph_to_ggplot2 <- function(graph, layout, vertex_size == NULL, vertex_color == NULL,
                              vertex_alpha == NULL, edge_size == NULL, edge_color == NULL,
                              edge_alpha == NULL, label_size == NULL, label_color == NULL,
                              label_alpha == NULL) {
...
#===================================================================================================
#' Plot network with ggplot2
#' 
#' Plot a graph structure defined by vertex and edge attributes using ggplot2.
#' This function only plots the basic structure. The ggplot2 object returned can be further
#' customized. 
#' 
#' @param vertex_data (\code{data.frame} with columns \code{x} and \code{y}) Used to creates graph
#' vertices.
#' @param edge_data (\code{data.frame} with columns \code{from} and \code{to}) Used to creates graph
#' edges.
#' 
#' @return A ggplot2 plot object. 
#' @export
ggplot2_network <- function(vertex_data, edge_data) {
