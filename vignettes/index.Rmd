...
A regular expression with capture groups and a corresponding key is used to define how files are parsed.
...
Taxa with too few sequences or sub-taxa are excluded and taxa with too many are subsampled.
...
This can be done with multiple primer pairs to compare their effectivness.
The code below uses *in silco* PCR with 515F/1100R and appends the results to those of 357F/519F:
