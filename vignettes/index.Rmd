...
* Sources of taxonomic data can be extracted from any file format and easily subset. 
...
The size range displayed is optimized for each plot by default but can also be set manually.
