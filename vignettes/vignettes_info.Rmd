...
To better see that this worked, the plot below makes has the number of sequences as node labels and makes rank 3 nodes larger so that they are easier to read.

```{r home_plot_6}
set.seed(3)
heat_tree(sampled, 
          node_size = n_obs * ifelse(n_supertaxa == 3, 5, 1),
          edge_size = n_obs, 
          node_label = n_obs,
          node_color = n_obs,
          tree_label = name)
...
For more inforamtion, see our website at http://grunwaldlab.github.io/metacoder_documentation/ and our github repository at https://github.com/grunwaldlab/metacoder.
