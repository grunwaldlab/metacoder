...
#### Get RDP mothur training data set
...
temp_dir_path <- tempdir() # make temporary directory
...
```{r}
unpacked_file_paths <- untar(local_file_path, list = TRUE) # get contents of archive
untar(local_file_path, exdir = temp_dir_path) # uncompress the archive
packed_fasta_path <- unpacked_file_paths[grepl("fasta$", unpacked_file_paths)] # identify the FASTA file
unpacked_fasta_path <- file.path(temp_dir_path, packed_fasta_path) # uncompress FASTA file
```
