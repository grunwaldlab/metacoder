...
plot_taxonomy(taxa$taxon_id, taxa$parent_id, vertex_size = taxa$item_count)
plot_taxonomy(sampled_taxa$taxon_id, sampled_taxa$parent_id, vertex_size = sampled_taxa$item_count)
```
