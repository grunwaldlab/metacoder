...
data <- extract_taxonomy(names(sequences),
                             ...
                             database = "none")
index <- taxonomic_sample(root_id = "1", item_ids = data$items$taxon_id, taxon_ids = data$taxa$taxon_id,
                          parent_ids = data$taxa$parent_id, ranks = data$taxa$rank, max_counts = c("c" = 10))
sampled_items <- data$items[index, ]
```
