...
vignette: >
  %\VignetteIndexEntry{Extracting taxonomy information from sequence metadata}
...
The first item in the header is sometimes a GenBank accesssion number, but not always.
...
This RDP FASTA file does not contain any referneces to taxon or sequence ids that could be used to look up more information.
...
```{r eval=FALSE}
file_path <- system.file("extdata", "rdp_release11_3_Archaea_unaligned.fa", package = "metacoder")
sequences <- ape::read.FASTA(file_path)
