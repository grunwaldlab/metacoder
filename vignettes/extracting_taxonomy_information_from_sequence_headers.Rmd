...
Note that the taxonmy returned by genbank could be different than the one in the header.
...
To do this, set the `use_internet` option to `FALSE` to prevent `extract_taxonomy` from trying to look up the taxon id.
